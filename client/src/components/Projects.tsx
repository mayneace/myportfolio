  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center text-center gap-3 sm:gap-4 mb-8 sm:mb-12">
        ...
        <div className="h-0.75 w-10 sm:w-15 bg-linear-to-r from-cyan-950 via-cyan-200 to-cyan-950 rounded-full" />
      </div>
                ...
                <div className="p-1 sm:px-20 md:px-1 sm:py-10 md:py-1 flex flex-col md:w-1/2">
                  ...
                  <div className="flex justify-center md:justify-start gap-1.5 mb-3">
                    {project.tags.map((tag, tIdx) => (
                      <span
                        key={tIdx}
                        className={`text-[8px] font-[Orbitron] border font-semibold uppercase tracking-widest px-1 py-0.5 rounded backdrop-blur-xs shadow-[0_5px_10px_rgba(0,0,0,0.1)] ${
                          isDarkMode
