  ...
  return (
    <>
      ...
      <div
        ...
        aria-hidden="true"
        className={`fixed inset-0 z-10 backdrop-blur-md pointer-events-none transition-opacity duration-500 ease-in-out md:hidden ${
          mobileMenuOpen
      ...
      <div
        className={`absolute top-full left-0 right-0 mx-6 mt-2 p-4 rounded-2xl border backdrop-blur-xs flex flex-col gap-2 md:hidden transition-all duration-300 ease-in-out z-40 ${
          mobileMenuOpen
            ? "opacity-100 translate-y-1 overflow-y-scroll pointer-events-auto visible"
            : "opacity-0 -translate-y-4 pointer-events-none invisible"
        } ${
          isDarkMode
            ? "bg-slate-900/30 border-slate-800/70 shadow-[0_40px_40px_rgba(0,0,0,0.7)]"
